...
public class TxEcdsaTest {
    ...
    static String[] attrs = {"policeNumber:00001", "policeType:1", "policeStatue:合肥市"};
    ...
    public void Tx1Test() {
        ...
        JSONObject tx2Json = dataUserEntityRegistration.generateTx2Json(au, aci);
        System.out.println(tx2Json);
        TxEcdsa txEcdsa = dataUserEntityRegistration.generateTx2Ecdsa(tx2Json);
        System.out.println(txEcdsa);
